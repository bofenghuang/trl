...
# wandb
export WANDB_PROJECT="2025-09-zaion-asr-audio-sft"
...
output_dir="./outputs/asr/audio_ft/zaion"

model_name="/projects/bhuang/models/llm/pretrained/mistralai/Voxtral-Mini-3B-2507"

train_dataset_file="/projects/bhuang/corpus/speech/zaion/segmented_hm_hm_nemo_16k/train_concat_sft.jsonl"
eval_dataset_file="/projects/bhuang/corpus/speech/zaion/segmented_hm_hm_nemo_16k/test_concat_sft.jsonl"

run_name="sft_voxtral_mini_3b_2507_lora_r64_ep3_bs32_lr1e4"
