...
# wandb
export WANDB_PROJECT="2025-09-zaion-summary-audio-sft"
...
train_dataset_file="/projects/bhuang/corpus/text/summary/edenred/generated_summaries/qwen3_235b_a22b_instruct_2507_fp8/sft_audio/train.jsonl"
eval_dataset_file="/projects/bhuang/corpus/text/summary/edenred/generated_summaries/qwen3_235b_a22b_instruct_2507_fp8/sft_audio/test.jsonl"

run_name="sft_gemma3n_e4b_it_lora_r64_ep5_bs128_lr1e4"
...
script_path="$root_dir/examples_b/audio_ft/sft.py"
    ...
    # --optim adamw_8bit \
    # --lora_exclude_modules ".*(vision_tower|embed_vision|audio_tower|embed_audio).*" \
