"""
Run audio SFT training with Unsloth model implementation.
...
def main(script_args, training_args, model_args, dataset_args):
    ...
    # Save and push to Hub (save lora)
    trainer.save_model(training_args.output_dir)
    # save unsloth merged model
    model.save_pretrained_merged(training_args.output_dir, processor)
