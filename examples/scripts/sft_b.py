...
def main():
    ...
    train_dataset = load_dataset("json", data_files=args.train_data_name_or_path, split="train")
    eval_dataset = load_dataset("json", data_files=args.eval_data_name_or_path, split="train") if args.eval_data_name_or_path else None
